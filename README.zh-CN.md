...
当前版本：**v0.18.0** —— 见 [`docs/release-notes/`](docs/release-notes/) 了解本版本变更。
...
- **结构化日志** —— 「设置 → 日志」实时查看所有隧道、会话、SFTP、Host key、更新等子系统的事件；按级别/类别/关键字筛选、点行看完整 JSON、一键导出 jsonl 用于反馈 bug；日志文件按天轮转在 `~/.shellx/logs/` 下，保留 7 天
