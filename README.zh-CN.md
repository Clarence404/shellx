...
当前版本：**v0.29.0** —— 见 [`docs/release-notes/`](docs/release-notes/) 了解本版本变更。
...
- **串口终端** —— 串口视图实时列出 COM 口（USB 转串口带芯片名）和已保存的连接；一键 115200 8N1 快速连接，或保存完整线路参数（波特率、数据位/停止位、校验、流控）。串口会话就是普通终端标签——复制粘贴、快捷键、分屏全部可用
