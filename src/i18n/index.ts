...
const zh: Record<string, string> = {
  ...
  "Encryption": "加密",
  "No encryption": "不加密",
  "Explicit TLS (FTPS · 21)": "显式 TLS（FTPS · 21）",
  "Implicit TLS (FTPS · 990)": "隐式 TLS（FTPS · 990）",
  "SSH (always encrypted)": "SSH（始终加密）",
  "Anonymous login": "匿名登录",
  "Advanced settings": "高级设置",
  "Transfer mode": "传输模式",
  "Passive (PASV)": "被动（PASV）",
  "Active (PORT)": "主动（PORT）",
  "Key file…": "密钥文件…",
  ...
  "open sessions will close": "个已打开的会话将断开",
  "tunnel rules go with it": "条隧道规则一并删除",
  "No open sessions, no tunnel rules.": "没有已打开的会话，也没有隧道规则。",
  "and": "还有",
  "more": "台",
  "Collapse": "收起",
  "host options": "主机选项",
  ...
  "Download": "下行",
  "Upload": "上行",
  "per-core load (hover for value)": "每核负载(悬停看数值)",
  "Processes": "进程",
  ...
  "Filesystem usage": "文件系统占用",
  "Throughput": "读写吞吐",
  "free": "剩",
  "No mounted filesystems reported.": "未报告已挂载的文件系统。",
  "Load": "负载",
  "System load": "系统负载",
  "1 / 5 / 15 min": "1 / 5 / 15 分钟",
  "not overloaded": "即不过载",
  "Total since boot": "开机累计",
  "Since boot": "开机以来",
  "read": "读",
  "write": "写",
  "avg CPU": "平均 CPU",
  ...
  "Docker needs passwordless sudo": "Docker 需要免密 sudo",
  "This user can't reach the Docker daemon directly, and passwordless sudo isn't set up for it. Add a sudoers rule so shellx can read container stats without a password:": "当前用户无法直接访问 Docker 守护进程，也没有配置免密 sudo。添加一条 sudoers 规则，让 shellx 无需密码即可读取容器信息：",
  "Run `sudo visudo` and add the line (swap in your username), then reopen this tab.": "运行 `sudo visudo` 添加上面这行（把用户名换成你自己的），然后重新打开此标签页。",
  "Container": "容器",
  "Block I/O": "块设备",
  "service(s) down": "服务异常",
  "Alerts": "异常",
