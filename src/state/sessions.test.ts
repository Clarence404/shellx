...
describe("sessions store", () => {
  ...
  it("adds a session and sets it active", () => {
    useSessions.getState().addSession({ id: "1", label: "a", kind: "ssh", host_id: null });
  ...
  it("removes a session and picks another as active if any remain", () => {
    ...
    s.addSession({ id: "1", label: "a", kind: "ssh", host_id: null });
    s.addSession({ id: "2", label: "b", kind: "ssh", host_id: null });
    s.removeSession("2");
  ...
  it("hostIsConnected() reflects whether a session with that host_id exists", () => {
    ...
    s.addSession({ id: "1", label: "a", kind: "ssh", host_id: "h1" });
